...
for f in casa.css casa-components.css casa.js casa-region-meta.js casa-browse-map.js casa-map-page.js casa-pages/home.css casa-pages/map.css robots.txt sitemap.xml index.html browse.html map.html; do
